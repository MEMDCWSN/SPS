...
#ifndef EXECCLUSTERBINS_H
#define EXECCLUSTERBINS_H
...
namespace specnets {
    ...
    class ExecClusterBins : public ExecBase
    {
    public:
        //! \name CONSTRUCTORS
        //@{
         ...
         */
        ExecClusterBins(const ParameterList & inputParams);
        ...
        ExecClusterBins(const ParameterList & inputParams, vector<SpecSet *> inputSpectra);


        //! \name DESTRUCTOR
        //@{
        virtual ~ExecClusterBins(void);
        //@}
    ...
    private:
        ...
        SpecSet *           m_filteredSpectra;
        SpecSet *           m_dissimilaritySpectra;
        SpecSet *           m_representativeSpectra;
        vector<SpecSet> *   m_inputComponents;
        tr1::unordered_map<string, tr1::unordered_map<unsigned int, unsigned int> > * m_index;
        tr1::unordered_map<string, tr1::unordered_map<unsigned int, unsigned int> > * m_fileIndex;
        tr1::unordered_map<string, tr1::unordered_map<unsigned int, unsigned int> > * m_globalIndex;
        tr1::unordered_map<string, tr1::unordered_map<unsigned int, string> > * m_identifications;
