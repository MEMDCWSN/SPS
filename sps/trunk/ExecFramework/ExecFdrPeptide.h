...
namespace specnets
{
  ...
  private:
    ...
    PeptideSpectrumMatchSet * m_inputPeptides; //! Combined (target/decoy) peptides we are considering.
    PeptideSpectrumMatchSet * m_inputTargets;  //! Separate target peptide results
    PeptideSpectrumMatchSet * m_inputDecoys;   //! Separate decoy peptide results
    PeptideSpectrumMatchSet * m_fdrResults;    //! FDR output
    ...
    bool performFdrSingleList(PeptideSpectrumMatchSet & inputPeptides,
                              PeptideSpectrumMatchSet & outputPeptides,
                              string                  & tdaType,
                              double                    scalingFactor);

    bool performFdrTwoLists(PeptideSpectrumMatchSet & targetPeptides,
                            PeptideSpectrumMatchSet & decoyPeptides,
                            PeptideSpectrumMatchSet & outputPeptides,
                            string                  & tdaType,
                            double                    scalingFactor);

    bool filterByProteinFdr(PeptideSpectrumMatchSet & inputPeptides,
                            string                  & tdaType,
                            int                       fdrType,
                            double                    scalingFactor);

    bool performSplitFdr(void);
