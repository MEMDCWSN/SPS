#ifndef __ExecFilterAligns_H__
#define __ExecFilterAligns_H__
...
namespace specnets
{
   ...
   */
  class ExecFilterAligns : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
     ...
     */
    ExecFilterAligns(const ParameterList & inputParams);
  ...
  private:
    ...
    SpecSet * m_spectra;    
    PeptideSpectrumMatchSet * m_filterPsmSet;  // PSM set for filtering by FDR
    ...
    std::vector<unsigned int> * m_idxKept;
    std::vector<TwoValues<float> > * m_pvalues;
