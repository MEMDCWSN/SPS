#ifndef __ExecFilterSpectra_H__
#define __ExecFilterSpectra_H__
...
namespace specnets
{
   ...
   */
  class ExecFilterSpectra : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
     ...
     */
    ExecFilterSpectra(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecFilterSpectra(void);
    //@}
