...
#ifndef EXECGENERATETAGS_H
#define EXECGENERATETAGS_H
...
namespace specnets {
    ...
    class ExecGenerateTags : public ExecBase
    {
    public:
        //! \name CONSTRUCTORS
        //@{
         ...
         */
        ExecGenerateTags(const ParameterList & inputParams);
        ...
        ExecGenerateTags(const ParameterList & inputParams, vector<SpecSet *> inputSpectra);


        //! \name DESTRUCTOR
        //@{
        virtual ~ExecGenerateTags(void);
        //@}
