...
#ifndef KL_EXECKLFILTER_H
#define KL_EXECKLFILTER_H
...
namespace specnets {
    ...
    class ExecKLFilter : public ExecBase
    {
    public:
        //! \name CONSTRUCTORS
        //@{
         ...
         */
        ExecKLFilter(const ParameterList & inputParams);
        ...
        ExecKLFilter(const ParameterList & inputParams, vector<SpecSet *> inputSpectra);


        //! \name DESTRUCTOR
        //@{
        virtual ~ExecKLFilter(void);
        //@}
    ...
    private:
        ...
        vector<SpecSet> *       m_filteredSpectra;
