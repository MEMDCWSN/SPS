#ifndef __ExecMolecularParallelPairs_H__
#define __ExecMolecularParallelPairs_H__
...
namespace specnets
{
   ...
   */
  class ExecMolecularParallelPairs : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
    /*! \brief The exemplar constructor.
     ...
     @sa clone()
     */
    ExecMolecularParallelPairs(void);
     ...
     */
    ExecMolecularParallelPairs(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecMolecularParallelPairs(void);
    //@}
...
#endif // __ExecMolecularParallelPairs_H__
