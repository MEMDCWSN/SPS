#ifndef __ExecPenaltyGen_H__
#define __ExecPenaltyGen_H__
...
namespace specnets
{
  ...
  class PenaltyMatrix;
	...
	/*! \brief Execution class for creating alignment penalities using pairs data

   Creates alignment penalities using pairs data.

   */
  class ExecPenaltyGen : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
     ...
     */
    ExecPenaltyGen(const ParameterList & inputParams);
    ...
    /*! \brief Constructor which takes both the parameters and the data structures
     ...
     executing the penalty alignment matrices. When using this constructor no external
     data need be read in.
