#ifndef __ExecPrmClustering_H__
#define __ExecPrmClustering_H__
...
namespace specnets
{
   ...
   */
  class ExecPrmClustering : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
     ...
     */
    ExecPrmClustering(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecPrmClustering(void);
    //@}
