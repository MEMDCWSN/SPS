#ifndef __ExecProteosafeToSpecnetsParams_H__
#define __ExecProteosafeToSpecnetsParams_H__
...
namespace specnets
{
   ...
   */
  class ExecProteosafeToSpecnetsParams : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
    /*! \brief The exemplar constructor.
     ...
     @sa clone()
     */
    ExecProteosafeToSpecnetsParams(void);
     ...
     */
    ExecProteosafeToSpecnetsParams(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecProteosafeToSpecnetsParams(void);
    //@}
  ...
  private:
    PenaltyMatrix * m_penaltyMatrix;

    void parsePtmSpecifications(void);
    
    void addParamFromProteoSAFe(const string & spsParam, const string & proteosafeParam, const bool mapYesNoToInt = false);

    void addDefaultParameterValues(void);
  };
