#ifndef EXECQCSPECTRALPAIRS_H_
#define EXECQCSPECTRALPAIRS_H_
...
namespace specnets
{
  class PSM {
        public:
                ...
                PSM(int specindex, string annopept, int cs, double obpmz, string input_protein);
  ...
  class ExecQCSpectralPairs : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
     ...
     */
	  ExecQCSpectralPairs(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecQCSpectralPairs(void);
    //@}
    ...
    void generate_precision_recall( set<std::string> spsPair,
                                    vector<PSM> pList,
    ...
    void generate_precision_recall_curve(   set<string> spsPair,
                                            vector<PSM> pList,
                                            bool        c_chargeSeperate,
                                            double      c_minOverlap,
                                            double  c_pmTolerance,
