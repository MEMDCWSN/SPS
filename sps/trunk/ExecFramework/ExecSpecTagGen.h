#ifndef __ExecSpecTagGen_H__
#define __ExecSpecTagGen_H__
...
namespace specnets
{
   ...
   */
  class ExecSpecTagGen : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
     ...
     */
    ExecSpecTagGen(const ParameterList & inputParams);
  ...
  private:
    ...
    SpecSet * m_contigSpectra;
    SpecSet * m_starSpectra;
    SpecSet * m_matchedContigs;
    PeptideSpectrumMatchSet * m_psmContigTags;
    PeptideSpectrumMatchSet * m_psmContigTagsDecoy;
    ...
    void makeSpectrumTagsFromContig(
             vector<
