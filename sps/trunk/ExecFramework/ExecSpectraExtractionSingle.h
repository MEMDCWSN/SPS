#ifndef __ExecSpectraExtractionSingle_H__
#define __ExecSpectraExtractionSingle_H__
...
namespace specnets
{
   ...
   */
  class ExecSpectraExtractionSingle : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
    /*! \brief The exemplar constructor.
     ...
     @sa clone()
     */
    ExecSpectraExtractionSingle(void);
     ...
     */
    ExecSpectraExtractionSingle(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecSpectraExtractionSingle(void);
    //@}
