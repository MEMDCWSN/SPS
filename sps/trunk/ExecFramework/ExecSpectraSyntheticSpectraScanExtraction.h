#ifndef __ExecSpectraSyntheticSpectraScanExtraction_H__
#define __ExecSpectraSyntheticSpectraScanExtraction_H__
...
namespace specnets
{
   ...
   */
  class ExecSpectraSyntheticSpectraScanExtraction : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
    /*! \brief The exemplar constructor.
     ...
     @sa clone()
     */
    ExecSpectraSyntheticSpectraScanExtraction(void);
     ...
     */
    ExecSpectraSyntheticSpectraScanExtraction(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecSpectraSyntheticSpectraScanExtraction(void);
    //@}
  ...
  private:
    ...
    std::string output_table_filename;
