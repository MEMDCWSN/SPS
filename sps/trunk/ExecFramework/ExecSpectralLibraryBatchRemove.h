#ifndef __ExecSpectralLibraryBatchRemove_H__
#define __ExecSpectralLibraryBatchRemove_H__
...
namespace specnets
{
   ...
   */
  class ExecSpectralLibraryBatchRemove : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
    /*! \brief The exemplar constructor.
     ...
     @sa clone()
     */
    ExecSpectralLibraryBatchRemove(void);
     ...
     */
    ExecSpectralLibraryBatchRemove(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecSpectralLibraryBatchRemove(void);
    //@}
  ...
  private:
    ...
    SpectralLibrary updated_library;
    
    std::string output_mgf_name;
    std::string library_path;
    std::vector<std::string> spectrum_IDs_to_remove;
