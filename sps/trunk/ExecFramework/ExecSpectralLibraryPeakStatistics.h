#ifndef __ExecSpectralLibraryPeakStatistics_H__
#define __ExecSpectralLibraryPeakStatistics_H__
...
namespace specnets
{
   ...
   */
  class ExecSpectralLibraryPeakStatistics : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
    /*! \brief The exemplar constructor.
     ...
     @sa clone()
     */
    ExecSpectralLibraryPeakStatistics(void);
     ...
     */
    ExecSpectralLibraryPeakStatistics(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecSpectralLibraryPeakStatistics(void);
    //@}
