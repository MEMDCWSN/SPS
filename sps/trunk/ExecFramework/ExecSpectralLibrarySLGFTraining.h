#ifndef __ExecSpectralLibrarySLGFTraining_H__
#define __ExecSpectralLibrarySLGFTraining_H__
...
namespace specnets
{
   ...
   */
  class ExecSpectralLibrarySLGFTraining : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
    /*! \brief The exemplar constructor.
     ...
     @sa clone()
     */
    ExecSpectralLibrarySLGFTraining(void);
     ...
     */
    ExecSpectralLibrarySLGFTraining(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecSpectralLibrarySLGFTraining(void);
    //@}
  ...
  private:
    ...
    std::string m_output_SLGF_lib;

    std::string m_output_file_path;

    std::string m_refined_training_spectral_library;

    std::vector<std::string> m_training_spectrum_file_names;
    std::vector<std::string> m_training_psm_file_names;
    //std::vector<std::string> m_training_mgf_file_names;

    SpectralLibraryGFSearch m_training_library;
    SpectralLibraryGFSearch m_distilled_spectral_lib;

    float m_pvalue_filter;
    float m_fdr_filter;
    float peak_tolerance;       //DW
