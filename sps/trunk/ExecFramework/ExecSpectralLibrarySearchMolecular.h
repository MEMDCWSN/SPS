#ifndef __ExecSpectralLibrarySearchMolecular_H__
#define __ExecSpectralLibrarySearchMolecular_H__
...
namespace specnets
{
   ...
   */
  class ExecSpectralLibrarySearchMolecular : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
    /*! \brief The exemplar constructor.
     ...
     @sa clone()
     */
    ExecSpectralLibrarySearchMolecular(void);
     ...
     */
    ExecSpectralLibrarySearchMolecular(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecSpectralLibrarySearchMolecular(void);
    //@}
  ...
  private:
    ...
    // Search related compounds and return best scoring hit
    // 0 disabled
    // 1 enabled
    int m_analog_search;

    int m_library_search_quality;

    bool m_force_exact_match;
