#ifndef __FirstCorrectTags_H__
#define __FirstCorrectTags_H__
...
namespace specnets
{
   ...
   */
  class FirstCorrectTags : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
     ...
     */
    FirstCorrectTags(const ParameterList & inputParams);
