...
namespace specnets
{
  ...
  public:
    ...
    void saveSNRRankedTags(const std::string & filename, int tagLen, int gap, int tagNum, float fragTol, bool isPRMSpec);

    void saveSNRRankedTags2(const std::string & filename, int tagLen, int gap, int tagNum, float fragTol, bool isPRMSpec);
